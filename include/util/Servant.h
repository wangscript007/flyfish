 ...
 * 每个对象的基类
 */
class Servant : public TC_ThreadRecMutex// : public BaseNotify
{
public:
    /**
     * 构造函数
...
public:
     ...
     * @return int
     */
	int doBus(JceCurrentPtr current, vector<char> &buffer);
...
public:
     ...
     * @return int
     */
	//int connectBus(const taf::BusCommuKey &cKey, taf::BusCommuData &sKey);
